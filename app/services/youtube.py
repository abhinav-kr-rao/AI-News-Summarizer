...
def get_latest_videos(channel_id: str, hours_lookback: int = 24) -> List[Dict]:
    """
...
if __name__ == "__main__":
    ...
    videos = get_latest_videos(test_channel_id, hours_lookback=4800) # Large lookback for testing to ensure we get something
